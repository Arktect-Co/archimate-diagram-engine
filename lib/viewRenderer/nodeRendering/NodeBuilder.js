    ...
    buildShape(name, type, width, height) {
        ...
        const buildBasicRetangular = (type, attributes) => {
            return this.builder.buildBasicRetangular(name, {
                width: width || this.settings.defaultWidth,
                height: height || this.settings.defaultHeight,
                fillColor: typeToHexColor(type, this.settings.style) || this.settings.lightColor,
                strokeColor: this.settings.darkColor,
                ...attributes
            });
        }
        ...
        switch (classification) {
            ...
            case "behaviour":
                return this.builder.buildBasicRounded(name, {
                    width,
                    height,
                    fillColor: typeToHexColor(type, this.settings.style)
                });
