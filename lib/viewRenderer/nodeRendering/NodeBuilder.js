...
class NodeBuilder {
    ...
    buildShape_(name, type, width, height) {
        ...
        switch (classification) {
            ...
            case "motivational":
                return this.builder.buildBasicOctogonal(name, {
                    width,
                    height,
                    fillColor: typeToHexColor(type, this.style)
                });
    ...
    buildNode(modelElementId, viewNodeId, name, type, width, height, posX, posY, parentElement) {
        let shape = this.buildShape_(name, type, width, height);
        ...
        shape.position(parseInt(posX), parseInt(posY));
        ...
        if (parentElement !== null && parentElement !== undefined) {
            ...
            shape.position(parseInt(posX), parseInt(posY), {parentRelative: true});
        }
